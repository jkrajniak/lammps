.. index:: fix adress/thermo

fix adress/thermo command
=========================
...
.. code-block:: LAMMPS
   ...
   fix ID group-ID adress/thermo region-ID transition-width keyword value ...

* ID, group-ID are documented in :doc:`fix <fix>` command
* adress/thermo = style name of this fix command
...
.. code-block:: LAMMPS
   ...
   fix 1 all adress/thermo transition 2.0 fix adres_region
   fix 1 all adress/thermo transition 2.0
...
:doc:`fix adress/region <fix_adres_region>` to determine which atoms
...
:doc:`fix adress/region <fix_adres_region>`, :doc:`pair adress <pair_adres>`,
